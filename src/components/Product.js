...
const Product = ({data}) => {
  return (
    ...
    <div className="text-lg flex justify-center">{data.title.length>25?data.title.slice(0,22):data.title}</div>
    <div className="text-md flex justify-center">{data.description.length>50?data.description.slice(0,50):data.description}...</div>
